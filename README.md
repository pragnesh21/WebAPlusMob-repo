...
* [CoreUI Free Angular Admin Template](https://github.com/coreui/WebAppByPM)
...
- [Download the latest release](https://github.com/coreui/WebAppByPM/)
- Clone the repo: `git clone https://github.com/coreui/WebAppByPM.git`
...
See [the Releases section of our project](https://github.com/coreui/WebAppByPM/releases) for changelogs for each release version.
